	...
	\begin{itemize}
		\item Stochastic block model
			\begin{itemize}
				...
				\item Adjacency matrix $A$ is generated according to the distribution
				\[
				...
				\]
			\end{itemize}
		\item Average degree $c = (\cin + \cout)/2$
			\begin{itemize}
				\item $L = D - A \approx c\id - A$
				\item Clustering by the largest $q$ eigenvectors of $A$
			\end{itemize}
...
%	\vspace{-5pt}
	...
	\begin{itemize}
		\item $n = 10^5$
			...
			%\end{itemize}
		\item Performance is measured by \textit{overlap}
		\vspace{-10pt}
		\begin{equation}
\label{eq:overlap}	
